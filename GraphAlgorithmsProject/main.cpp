    ...
    while (true)
    {
        ...
        if (number == 1)
        {
            while (true)
            {
                ...
                else if (number == 5)
                {
                    if (graph != NULL)
                    {
                        printf("Algorytm Kruskala\n");
                        printf("\nLista sasiedztwa:\n");
                        
                        graph->kruskalAlgorithmAdjacencyList();
              
                        graph->printMST();

                        printf("\nMacierz sasiedztwa:\n");
                        
                        graph->kruskalAlgorithmAdjacencyMatrix();
        ...
        else if (number == 2)
        {
            while (true)
            {
                ...
                printf("5. Przejdz do glownego menu\n");
